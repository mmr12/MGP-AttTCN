...
class GP_TCN:
    def __init__(self,
        ...
        self.TCN = make_model(time_window=time_window,
                                  no_channels=n_features + n_stat_features,
                                  L2reg=L2reg,
                                  DO=DO,
    ...
    def __call__(self, inputs):
        ...
        return self.TCN(self.TCN_input)
    ...
    def set_weights(self, weights):
        ...
        self.TCN.set_weights(weights[self.n_GP_var:])
